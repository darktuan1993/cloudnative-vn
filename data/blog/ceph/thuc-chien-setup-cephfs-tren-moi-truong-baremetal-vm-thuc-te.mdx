---
title: '[Thực chiến] Setup CephFS trên môi trường BareMetal / VM thực tế'
description: '[Thực chiến] Setup CephFS trên môi trường thực tế'
date: '2021-05-18'
tags: ['Cloudnative', 'Storage', 'CephFS']
authors: ['bachdangtuan']
summary: '[Thực chiến] Setup CephFS trên môi trường BareMetal / VM thực tế'
---
