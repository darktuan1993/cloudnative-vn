...
5. [Kịch bản xử lý sự cố hệ thống](#xu-ly-su-co)
...
| Gộp MON, MGR, MDS và OSD trên cùng node | | UAT/Staging | 5-6 VM | Tách vai trò, có standby MDS |
...
Triển khai CephFS với 6 node ``` +-------------+ | Client(s) | +-------------+ | Mount CephFS |
+----------------------------+ | Ceph Cluster Network | +----------------------------+
+------------+------------+-------------+------------+-----------+ | | | | | | +--------+ +--------+
+--------+ +--------+ +--------+ +--------+ | node1 | | node2 | | node3 | | node4 | | node5 | |
node6 | |--------| |--------| |--------| |--------| |--------| |--------| | MON | | MON | | MON | |
| | | | | | MGR(A) | | MGR(S) | | | | | | | | | | MDS(A) | | MDS(S) | | | | | | | | | | OSD | | OSD
| | OSD | | OSD | | OSD | | OSD | +--------+ +--------+ +--------+ +--------+ +--------+ +--------+
